        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12 pb-16 border-b border-[#E2DDD5]">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <ul className="space-y-2 text-base font-normal">
              ...
              <li><button onClick={() => onOpenLegal('gewaehrleistung')} className="hover:text-[#B85D2C] transition-colors">{lang === 'de' ? 'Gesetzliche Gewährleistung' : 'Legal Guarantee'}</button></li>
            </ul>
          </div>
